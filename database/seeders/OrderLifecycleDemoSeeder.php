    ...
    public function run(
        ...
        $scenarios = [
            ...
            [
                ...
                'description' => 'Pending — Online Card after one failed attempt and retry',
            ],
            [
                ...
                'name' => 'Maya Nassar',
                'payment_method' => 'online_card',
                'description' => 'Pending Order — Online Card payment failed',
            ],
            [
                'key' => 'processing-cod',
            ...
            [
                ...
                'name' => 'Lina Daher',
                'payment_method' => 'online_card',
                'description' => 'Processing — Online Card paid before processing',
            ],
            [
