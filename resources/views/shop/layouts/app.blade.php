...
<head>
    ...
    <!-- Libraries -->
    <link href="{{ asset('storefront-assets/lib/animate/animate.min.css') }}" rel="stylesheet">
    <link href="{{ asset('storefront-assets/lib/owlcarousel/assets/owl.carousel.min.css') }}" rel="stylesheet">

    <!-- Bootstrap -->
    <link href="{{ asset('storefront-assets/css/bootstrap.min.css') }}" rel="stylesheet">

    <!-- Template -->
    <link href="{{ asset('storefront-assets/css/style.css') }}" rel="stylesheet">
