        ...
        <div class="body-wrapper">
            ...
            <div class="body-wrapper-inner">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-6">
                            <h4><b>Review Moderation</b></h4>
                        </div>
                        <div class="col-6 text-end d-flex justify-content-end gap-2">
                            <a href="{{ route('admin.reviews.index') }}" class="btn btn-transparent">Back</a>
                        </div>
                    </div>
                    ...
                    <section class="card shadow-sm mb-4" aria-labelledby="review-details-heading">
                        <div class="card-header">
                            <h2 id="review-details-heading" class="h5 mb-0">Review Details</h2>
                        </div>
                        <div class="card-body">
                            <dl class="mb-0">
                                <dt>Rating</dt>
                                ...
                                <dd>{{ $review->review }}</dd>
                                <dt>Status</dt>
                                <dd>{{ ucfirst($review->status->value) }}</dd>
                            </dl>
                        </div>
                    </section>
                    ...
                    <section class="card shadow-sm mb-4" aria-labelledby="review-evidence-heading">
                        <div class="card-header">
                            <h2 id="review-evidence-heading" class="h5 mb-0">Product, Customer, and Purchase Evidence
                            </h2>
                        </div>
                        <div class="card-body">
                            <dl class="mb-0">
                                <dt>Product</dt>
                                <dd>{{ $review->product->translations->first()?->name ?? $review->product->sku }}</dd>
                                <dt>Customer</dt>
                                <dd>{{ $review->customer->name }} ({{ $review->customer->email }})</dd>
                                <dt>Order</dt>
                                <dd>{{ $review->orderItem?->order?->order_number ?? 'Evidence order no longer available' }}
                                </dd>
                            </dl>
                        </div>
                    </section>
                    ...
                    <section class="card shadow-sm" aria-labelledby="review-moderation-heading">
                        <div class="card-header">
                            <h2 id="review-moderation-heading" class="h5 mb-0">Moderation Actions</h2>
                        </div>
                        <div class="card-body">
