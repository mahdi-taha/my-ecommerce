...
<div class="card shadow-sm mb-4">
    <div class="card-header"><h2 class="h5 mb-0">Service Information</h2></div>
    <div class="card-body">
        <div class="row g-3">
            <div class="col-md-4">
            ...
            <div class="col-md-4 d-flex align-items-center pt-md-4">
                ...
                <div class="form-check form-switch">
                    <input id="is_active" name="is_active" value="1" type="checkbox"
                        ...
                        @checked(old('is_active', $homepageService->is_active ?? false))>
...
@foreach (['en' => 'English Content', 'ar' => 'Arabic Content'] as $locale => $heading)
    ...
    <div class="card shadow-sm mb-4" @if ($locale === 'ar') dir="rtl" @endif>
        <div class="card-header"><h2 class="h5 mb-0">{{ $heading }}</h2></div>
        <div class="card-body">
            <div class="mb-3">
                ...
                @error('title_' . $locale)<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>
            <div>
                ...
                @error('description_' . $locale)<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>
        </div>
    </div>
@endforeach
...
<div class="card shadow-sm">
    ...
    <div class="card-body text-end">
        <a href="{{ route('admin.homepage-services.index') }}" class="btn btn-light">Cancel</a>
        <button type="submit" class="btn btn-primary">{{ $isEdit ? 'Update Homepage Service' : 'Create Homepage Service' }}</button>
    </div>
</div>
