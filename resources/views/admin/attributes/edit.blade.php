<x-admin-main page="Edit Attribute">
    <x-slot name="header">
        ...
        <div class="body-wrapper">
            ...
            <div class="body-wrapper-inner">
                <div class="container-fluid">
                    ...
                    <hr />
                    <form action="{{ route('admin.attributes.update', $attribute->id) }}" method="post" onsubmit="disableSubmitButton(this)">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3 mt-1">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('attribute_code', $attribute->code) }}"
                                                    placeholder="Enter attribute code" disabled>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3 mt-1">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('attribute_name_en', $en_name?->admin_name) }}"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3 mt-1">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('attribute_name_ar', $ar_name?->admin_name) }}"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3 mt-1">
                                                ...
                                                <input type="number" min="0" step="1"
                                                    ...
                                                    value="{{ old('attribute_sort_order', $attribute->sort_order) }}"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3 mt-1">
                                                ...
                                                <select
                                                    ...
                                                    id="attribute_type" name="attribute_type" disabled>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3 mt-1">
                                                ...
                                                <select
                                                    ...
                                                    id="attribute_swatch_type" name="attribute_swatch_type" {{ $attribute->type === 'text' ? 'disabled' : '' }}>
                                                    <option value="">Select swatch type</option>
                                                    <option value="text"
                                                        {{ old('attribute_swatch_type', $attribute->swatch_type) == 'text' ? 'selected' : '' }}>
                                                        text</option>
                                                    <option value="dropdown"
                                                        {{ old('attribute_swatch_type', $attribute->swatch_type) == 'dropdown' ? 'selected' : '' }}>
                                                        dropdown</option>
                                                    <option value="color"
                                                        {{ old('attribute_swatch_type', $attribute->swatch_type) == 'color' ? 'selected' : '' }}>
                                                        color</option>
                                                </select>
                                        ...
                                        <div class="col-lg-4 py-3">
                                            <label class="fs-2 text-dark" style="cursor: pointer;"
                                                ...
                                                <input type="checkbox"
                                                    ...
                                                    {{ old('is_configurable', $attribute->is_configurable) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-4 py-3">
                                            <label class="fs-2 text-dark" style="cursor: pointer;">
                                                ...
                                                <input type="checkbox"
                                                    ...
                                                    value="1"
                                                    {{ old('is_visible_on_front', $attribute->is_visible_on_front) ? 'checked' : '' }}>
