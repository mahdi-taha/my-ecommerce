...
<div class="card shadow-sm mb-4">
    ...
    <div class="card-body">
        ...
        <div class="form-text">
            ...
            <ul class="mb-0 ps-3">
                <li><strong>Hero:</strong> recommended 1600 × 1600 px (1:1).</li>
                <li><strong>Hero Side:</strong> recommended 1200 × 1200 px (1:1).</li>
                <li><strong>Offer:</strong> recommended 1200 × 900 px (4:3).</li>
            </ul>
