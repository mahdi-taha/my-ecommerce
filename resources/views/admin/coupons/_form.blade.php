...
<div class="row">
    <div class="col-lg-8">
        <div class="card shadow-sm">
            <div class="card-header"><h5 class="mb-0">Coupon</h5></div>
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" id="minimum_subtotal" name="minimum_subtotal" min="0" step="0.0001"
                            value="{{ old('minimum_subtotal', $coupon->minimum_subtotal ?? '') }}"
    ...
    <div class="col-lg-4">
        <div class="card shadow-sm">
            <div class="card-header"><h5 class="mb-0">Limits and Status</h5></div>
            <div class="card-body">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" id="per_customer_usage_limit" name="per_customer_usage_limit" min="1" step="1"
                    ...
                    @error('per_customer_usage_limit')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                ...
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" id="is_first_order_only"
                        name="is_first_order_only" value="1"
                        @checked(old('is_first_order_only', $coupon->is_first_order_only ?? false))>
